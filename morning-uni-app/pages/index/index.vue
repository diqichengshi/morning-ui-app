<template>
	<view class="container">
		...
		<view class="hot-floor">
			...
			<scroll-view class="floor-list" scroll-x>
				<view class="scoll-wrapper">
					<view v-for="(item, index) in recommendNiceProductList" :key="index" class="floor-item" @click="navToDetailPage(item)">
		...
		<view class="group-section">
			<swiper class="g-swiper" :duration="500">
				<swiper-item class="g-swiper-item" v-for="(item, index) in groupBuyProductList" :key="index" v-if="index%2 === 0" @click="navToDetailPage(item)">
					...
					<view class="g-item right">
						<view class="t-box">
							<text class="title clamp">{{groupBuyProductList[index+1].title}}</text>
							<view class="price-box">
								<text class="price">￥{{groupBuyProductList[index+1].showPrice}}</text>
								<text class="m-price">￥188</text>
							</view>
							<view class="pro-box">
								<view class="progress-box">
						...
						<image :src="groupBuyProductList[index+1].showImg" mode="aspectFill"></image>
					</view>
				</swiper-item>
			</swiper>
		</view>
		...
		<view class="guess-section">
			<view v-for="(item, index) in recommendLikeProductList" :key="index" class="guess-item" @click="navToDetailPage(item)">
	...
	export default {
		...
		data() {
			return {
				...
				seckillProductList: [],
				groupBuyProductList: [],
				recommendNiceProductList: [],
				recommendLikeProductList: [],
				goodsList: []
			};
		},
