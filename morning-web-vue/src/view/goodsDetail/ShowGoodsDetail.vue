    ...
    <div class="item-intro-show">
      <div class="item-intro-recommend">
        ...
        <div class="item-intro-recommend-column">
          <div class="item-recommend-column" v-for="(item, index) in goodsInfo.hotProductList" :key="index">
            <div class="item-recommend-img">
              <img :src="item.bigImg" alt="">
            </div>
            <div class="item-recommend-intro">
              <span>
                <span class="item-recommend-top-num">{{index + 1}}</span> 热销{{item.salesVolume}}件</span>
              <span class="item-recommend-price">￥{{item.showPrice}}</span>
            </div>
          </div>
        </div>
      </div>
          ...
          <Tabs>
            <TabPane label="商品介绍">
              ...
              <div class="item-intro-img" ref="itemIntroGoods">
                <img :src="item" alt="" v-for="(item,index) in goodsInfo.detail" :key="index">
              </div>
            </TabPane>
            <TabPane label="规格参数">
              <div class="remarks-title">
              ...
              <div class="item-param-container">
                <span class="item-param-box" v-for="(item,index) in goodsInfo.parameter" :key="index">
              ...
              <div class="remarks-container">
                ...
                <div class="remarks-analyse-box">
                  <div class="remarks-analyse-goods">
                    <i-circle :percent="goodsInfo.conmmentDetail.goodAnalyse" stroke-color="#e4393c">
                      <span class="remarks-analyse-num">{{goodsInfo.conmmentDetail.goodAnalyse}}%</span>
                      <p class="remarks-analyse-title">好评率</p>
                    </i-circle>
                  </div>
                  <div class="remarks-analyse-tags">
                    <Tag checkable :color="tagsColor[index % 4]" v-for="(item,index) in goodsInfo.conmmentDetail.conmmentTags" :key="index">{{item}}</Tag>
                  </div>
                </div>
                <div class="remarks-bar">
                  <!--<span>追评({{goodsInfo.commentNumDetail[0]}})</span>
                  <span>好评({{goodsInfo.commentNumDetail[1]}})</span>
                  <span>中评({{goodsInfo.commentNumDetail[2]}})</span>
                  <span>差评({{goodsInfo.commentNumDetail[3]}})</span>-->
                  <span>追评(1000)</span>
                  <span>好评(850)</span>
                  <span>中评(300)</span>
                  <span>差评(200)</span>
                </div>
                <div class="remarks-box" v-for="(item,index) in goodsInfo.conmmentDetail.conmmentList" :key="index">
                  ...
                  <div class="remarks-content-box">
                    ...
                    <p class="remarks-sub">
                      <span class="remarks-item">{{item.userName}}</span>
...
<script>
import ShowProductWarranty from '@/view/goodsDetail/ShowProductWarranty';
