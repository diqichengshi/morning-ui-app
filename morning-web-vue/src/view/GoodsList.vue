    ...
    <div class="container">
      ...
      <div class="goods-box">
        <div class="as-box">
          ...
          <div class="item-as" v-for="(item,index) in niceGoodsList" :key="index">
          ...
          <div class="goods-list">
            <div class="goods-show-info" v-for="(item, index) in goodsList" :key="index">
              <div class="goods-show-img">
                <router-link :to="{path:'/goodsDetail',query:{productId:item.productId}}">
                  <img :src="item.bigImg"/>
                </router-link>
              </div>
...
import GoodsClassNav from '@/view/nav/GoodsClassNav';
